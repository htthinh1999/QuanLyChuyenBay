...
myApp.controller('cau2_controller', function ($scope, $state, $http, $location) {
    var vm = this;
    ...
    this.loadData = function (page_number) {
        ...
        $http.get('model/select-cau2.php?page=' + page_number + '&search_input=' + search_input).then(function (response) {

        ...
        <div class="col-lg-8 mt-12" >
                            ...
                            <div class="input-group col-md-12">
                                ...
                                <span class="input-group-btn">
                                    <button ng-click="std_ctrl2.search_data(search_input)" class="button button-green" type="button">
...
<p class="{{std_ctrl2.alert_class}}">{{std_ctrl2.msg}}</p>
<table class="table">
            <thead>
                <tr>                  
            ...
            <tbody>
                ...
                <tr ng-repeat="sinhviens in std_ctrl2.sinhvien_list">
                ...
                <td  class="text-right">
                    ...
                    <button type="button"  data-toggle="modal"  class="button button-red" ng-click="std_ctrl2.delete_sinhvien_info(sinhviens.SV_id)">Delete</button> 
                  
                    <button  type="button" data-toggle="modal" data-target="#edit_sinhvien_info_modal"  class="button button-blue" ng-click="std_ctrl2.edit_sinhvien_info(sinhviens.MANV)">Edit</button> 
                  
                    <button type="button" data-toggle="modal" data-target="#view_sinhvien_info_modal"  class="button button-green" ng-click="std_ctrl2.get_sinhvien_info(sinhviens.SV_id)">View</button> 
